...
const partners = [
  {
    ...
    desc: "Expand your business with a proven, fast-moving Ayurvedic portfolio and protected territories.",
  ...
  },
  {
    ...
    desc: "Launch your own branded Ayurvedic line with bespoke formulations and packaging support.",
...
export default function Partner() {
  return (
    <section id="partner" className="relative overflow-hidden bg-white px-5 py-24 md:px-10 md:py-36 lg:px-20">
      <Mandala
        petals={10}
      ...
      <div className="relative mx-auto max-w-[1280px]">
        <Reveal className="mb-16 text-center md:mb-24">
          ...
          <p className="font-v2-body mx-auto max-w-[640px] text-[15.5px] leading-[1.85] text-[#0B1F4E]/60">
            Three ways to work with a partner built for quality, scale, and
            reliability.
          </p>
        </Reveal>
