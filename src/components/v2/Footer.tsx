  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto max-w-[1280px] px-5 pt-32 pb-10 md:px-10 lg:px-16">
        ...
        {/* Giant watermark */}
        <div
          className="font-v2-head pointer-events-none mt-6 -mb-16 text-center leading-none font-semibold tracking-[0.05em] text-white/[0.045] select-none"
          style={{ fontSize: "clamp(90px, 16vw, 240px)" }}
        >
          TAVIAR
        </div>
      </div>
