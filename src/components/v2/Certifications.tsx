...
const certs = [
  ...
  },
  {
    ...
    desc: "Fully licensed distributor of Ayurvedic proprietary formulations.",
    icon: (
      <svg viewBox="0 0 24 24" fill="none" className="h-7 w-7" aria-hidden>
    ...
    >
      <div className="relative mx-auto max-w-[1280px]">
        ...
        <Reveal delay={200} className="mt-14 text-center">
          <a
            href="#contact"
            className="font-v2-body group inline-flex items-center gap-2.5 rounded-full border border-[#1E40AF]/25 bg-white/70 px-8 py-4 text-[11.5px] font-bold tracking-[2px] text-[#0B1F4E] uppercase transition-all duration-300 hover:border-[#1E40AF]/60 hover:bg-white"
          >
            Request certificates (PDF)
