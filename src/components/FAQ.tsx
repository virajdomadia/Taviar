...
const faqData = [
  ...
  },
  {
    ...
    a: "We provide end-to-end private label services, allowing you to launch a fully branded Ayurvedic skincare range with bespoke formulations, packaging design, and compliance support.",
  },
  {
    q: "Are products suitable for all skin types?",
    a: "Our formulations are dermatologically tested and developed for all skin types, including sensitive skin. Each product specifies its ideal use and skin concern on the label.",
  },
  {
