  ...
  useEffect(() => {
    ...
    const draw = (t: number) => {
      ...
      bk.forEach((b) => {
        ...
        g.addColorStop(0, `rgba(30,64,175,${b.a * 2.6})`);
        g.addColorStop(0.5, `rgba(30,58,138,${b.a})`);
      ...
      pts.forEach((p) => {
        ...
        if (p.strand) {
          ctx.strokeStyle = `rgba(60,100,200,${p.a * tw * 1.25})`;
          ...
          g2.addColorStop(0, `rgba(130,165,230,${p.a * tw})`);
          g2.addColorStop(1, "rgba(30,64,175,0)");
          ctx.fillStyle = g2;
          ctx.beginPath();
